            ...
            <form class="form-horizontal new-content" role="form" enctype="multipart/form-data" method="POST" action="{{route('admin.strains.store')}}">
                ...
                <div class="form-group row col-md-12">
                    <label class="btn btn-warning btn-file">
                        Choose Image <input type="file" style="display: none;" onchange="previewFile()" name="image" value="{{old('image')}}" >
                    </label>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <input name="min_flowering_time" type="number" min="6" max="15" default="9" id="min_flowering_time" value="{{old('min_flowering_time')}}" />
                    </div>
                    <div class="col-md-6">
                        <label for="max_flowering_time">Max Weeks</label>
                        <input type="number" min="6" max="15" default="9" name="max_flowering_time" id="max_flowering_time" value="{{old('max_flowering_time')}}" />
                    </div>
                </div>
                <div class="form-group row">
